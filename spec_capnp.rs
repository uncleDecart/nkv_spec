...
pub mod base_message {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 63] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(115, 112, 101, 99, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 66, 97, 115, 101, 77),
...
pub mod put_message {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 47] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(115, 112, 101, 99, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 80, 117, 116, 77, 101),
...
pub mod base_resp {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 62] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(115, 112, 101, 99, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 66, 97, 115, 101, 82),
...
pub mod data_resp {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 51] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(115, 112, 101, 99, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 68, 97, 116, 97, 82),
      ::capnp::word(101, 115, 112, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(8, 0, 0, 0, 3, 0, 4, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub mod notification {
  pub use self::Which::{Hello,Update,Close,Notfound};
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_hello(&mut self, _value: ())  {
      self.builder.set_data_field::<u16>(0, 0);
    }
    #[inline]
    pub fn init_update(mut self, ) -> crate::spec_capnp::notification::update::Builder<'a> {
      self.builder.set_data_field::<u16>(0, 1);
    ...
    #[inline]
    pub fn init_close(mut self, ) -> crate::spec_capnp::notification::close::Builder<'a> {
      self.builder.set_data_field::<u16>(0, 2);
      self.builder.reborrow().get_pointer_field(0).clear();
      self.builder.into()
    }
    #[inline]
    pub fn set_notfound(&mut self, _value: ())  {
      self.builder.set_data_field::<u16>(0, 3);
    }
    #[inline]
    pub fn which(self) -> ::core::result::Result<WhichBuilder<'a,>, ::capnp::NotInSchema> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 64] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(139, 13, 249, 254, 52, 96, 206, 129),
      ::capnp::word(11, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(190, 8, 91, 15, 118, 94, 5, 173),
      ...
      ::capnp::word(105, 99, 97, 116, 105, 111, 110, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(16, 0, 0, 0, 3, 0, 4, 0),
      ::capnp::word(0, 0, 255, 255, 0, 0, 0, 0),
      ::capnp::word(0, 0, 1, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(1, 0, 254, 255, 0, 0, 0, 0),
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(98, 103, 105, 84, 212, 124, 10, 169),
      ...
      ::capnp::word(2, 0, 253, 255, 0, 0, 0, 0),
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(8, 173, 41, 43, 200, 16, 234, 174),
      ...
      ::capnp::word(110, 111, 116, 102, 111, 117, 110, 100),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        ...
        1 => <crate::spec_capnp::notification::update::Owned as ::capnp::introspect::Introspect>::introspect(),
        2 => <crate::spec_capnp::notification::close::Owned as ::capnp::introspect::Introspect>::introspect(),
    ...
    pub const TYPE_ID: u64 = 0x81ce_6034_fef9_0d8b;
  }
  ...
  pub type WhichReader<'a,> = Which<crate::spec_capnp::notification::update::Reader<'a>,crate::spec_capnp::notification::close::Reader<'a>>;
  pub type WhichBuilder<'a,> = Which<crate::spec_capnp::notification::update::Builder<'a>,crate::spec_capnp::notification::close::Builder<'a>>;
  ...
  pub mod update {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 47] = [
        ...
        ::capnp::word(115, 112, 101, 99, 46, 99, 97, 112),
        ::capnp::word(110, 112, 58, 78, 111, 116, 105, 102),
        ::capnp::word(105, 99, 97, 116, 105, 111, 110, 46),
        ::capnp::word(117, 112, 100, 97, 116, 101, 0, 0),
        ::capnp::word(8, 0, 0, 0, 3, 0, 4, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 1, 0, 1, 0, 0, 0),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[0,1];
      pub const TYPE_ID: u64 = 0xa90a_7cd4_5469_6762;
    }
  }
